  ...
  <Base>
    <BaseContent>
      <ArticleProse>
        ...
        <p>I've been dreaming of a simple md-driven site that pulls from a data repository for a long time. Oddly enough, my biggest personal inspiration for a website has been the Mac OS notes app for a few years now. So I'm giving it a shot to see where I get.</p>
        <p>So far I'm *part* of the way there, I've got the `.md` part going... Once the basic site is done I'll pivot to figure out how to pull things directly from my personal <a href="https://github.com/iamnbutler/data">data</a> repo.</p>
        <h2>Why is the site kinda jank?</h2>
        <p>Welcome to my very 'build-in-the-open' personal site. Expect everything not to work!</p>
