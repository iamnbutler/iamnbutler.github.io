...
***Edit: This was written before the M1X was launched. Don't invest in an M1 device over an M1X, even if it is a good amount cheaper.***
...
This one is pretty good, my only complaints are 1) it is pretty wobbly when you go to press th buttons and 2) the buttons are capacitive. I'd eventually like to replace this with something more sturdy with physical buttons.
