...
// Post object
export const writingWithADHD: IProject = {
    title: "Writing With ADHD",
    slug: "writing-with-adhd",
    url: "/writing-with-adhd",
    tagline: "This shit is hard 😅",
    preview:
        `I've convinced myself my whole life that I'm an absolutely terrible writer. The things that I write flow awkwardly, and I never understand all the rules of writing and the way to make things sound immersive and natural.

My writing ends up awkwardly verbose and tends to wander a lot. I tend to mix tenses constantly.
