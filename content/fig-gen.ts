...
// Post object
export const figGen: IProject = {
    title: "Generative Art with Figma & Automator",
    slug: "fig-gen",
    url: "/fig-gen",
    tagline: "Exploring the new Automator plugin for Figma.",
    preview:
        `I thought exploring a
          minimal generative series using pixels and mapping equations would be a fun
          way to try it out.`,
    date: {
        raw: new Date("2021/11/06"),
        year: "2021",
        mmddyy: "11/06/21",
        relative: "today", // Replace with an actual relative date calculation
    },
    cover: {
        src: "/project/fig-gen/thumbnail.png",
        alt: "",
    },
    tags: [
        { title: "art", slug: "art", url: "/tags/art" },
    ],
    content: `Exploring the new Automator plugin for Figma. I thought exploring a minimal generative series using pixels and mapping equations would be a fun way to try it out.
