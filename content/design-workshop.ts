...
// Post object
export const designWorkshop: IProject = {
    title: "Design Workshop",
    slug: "design-workshop",
    url: "/design-workshop",
    tagline: "Subverting the design process, discovering weakness, and ultimately finding creativity and strength.",
    preview:
    ...
    date: {
        raw: new Date("2015-03-12"),
        year: "2015",
        mmddyy: "03/12/15",
        relative: "8 years ago", // Replace with an actual relative date calculation
    },
    cover: {
        src: "/project/design-workshop/thumbnail.png",
        alt: "",
    },
    tags: [
        { title: "art", slug: "art", url: "/tags/art" },
        { title: "design", slug: "design", url: "/tags/design" },
    ],
    content: `This is a project about discovery, identifying weakness, and finding strength. A two part project: one part illustration, one part narrative. It was born out of a desire to make without a problem, to make for the sake of making.
