...
const GridItem = ({ children }: PropsWithChildren) => (
  <section className="p-5 bg-white">{children}</section>
);
  ...
  return (
    <div
      className={clsx(
        ...
        "sm:flex sm:flex-col md:grid md:grid-cols-4 md:mx-auto lg:grid-cols-2 lg:grid-rows-[760px] xl:grid-rows-auto 2xl:grid-cols-4"
      )}
    >
      <GridItem>
        <header>
