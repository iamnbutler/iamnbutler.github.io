...
export const article = {
  ...
  description: 'My wife is a huge Kingdom Hearts fan, so when I discovered that 3D printing metal was not only possible but also not overly expensive, I decided to make her a custom Keyblade piece...',
}
...
My wife is a huge Kingdom Hearts fan, so when I discovered that 3D printing metal was not only possible but also not overly expensive, I decided to make her a custom Keyblade piece. The project involved sketching, 3D renders, prototyping, and final printing.
