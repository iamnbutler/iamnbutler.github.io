...
export const article = {
  ...
  date: '2021-03-19',
  title: 'zed.dev',
  description: "We shipped our first site for Zed! We are currently in deep development, but wanted a way for people to learn more about what we are building, and have a way to know when new info drops.",
}
...
We shipped our first site for Zed!
